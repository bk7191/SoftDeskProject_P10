...
class CommentAdmin(admin.ModelAdmin):
    list_display = ('text', 'author', 'issue', 'created_time')  # Fields to display in the list view
    search_fields = ('text',)  # Fields to search by
    list_filter = ('issue__project',)  # Filter by project (assuming Issue has a foreign key to Project)
